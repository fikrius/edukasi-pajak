                        ...
                        <div class="cat-cap">
                            ...
                            <ol class="ordered-list text-left">
                                <li>
                                    ...
                                    <img style="max-width: 100%; margin-top: 1rem; margin-bottom: 1rem;" class="rounded" src="{{ asset('/img/gallery/perorangan/1.png') }}" alt="pilih jenis pajak">
                                </li>
                                <li>
                                    Jika wajib pajak perorangan maka akan muncul tampilan seperti dibawah ini :
                                    <img style="max-width: 100%; margin-top: 1rem; margin-bottom: 1rem;" class="rounded" src="{{ asset('/img/gallery/perorangan/2.png') }}" alt="tampilan pajak perorangan">
                                </li>
                                <li>
                                    Masukkan tahun pembuatan NPWP
                                    <img style="max-width: 100%; margin-top: 1rem; margin-bottom: 1rem;" class="rounded" src="{{ asset('/img/gallery/perorangan/3.png') }}" alt="tahun pembuatan NPWP">
                                </li>
                                <li>
                                    Masukkan dasar pengenaan pajak
                                    <img style="max-width: 100%; margin-top: 1rem; margin-bottom: 1rem;" class="rounded" src="{{ asset('/img/gallery/perorangan/4.png') }}" alt="dasar pengenaan pajak">
                                </li>
                                <li>
                                    Tarif pajak sebesar 0,5% untuk pajak perorangan
                                    <img style="max-width: 100%; margin-top: 1rem; margin-bottom: 1rem;" class="rounded" src="{{ asset('/img/gallery/perorangan/5.png') }}" alt="tarif pajak perorangan">
                                </li>
                                <li>
                                    Kemudian tekan tombol hitung pajak
                                    <img style="max-width: 100%; margin-top: 1rem; margin-bottom: 1rem;" class="rounded" src="{{ asset('/img/gallery/perorangan/7.png') }}" alt="tombol hitung pajak">
                                </li>
                                <li>
                                    Maka pajak yg harus di setorkan akan muncul setelah dikalkulasi
                                    <img style="max-width: 100%; margin-top: 1rem; margin-bottom: 1rem;" class="rounded" src="{{ asset('/img/gallery/perorangan/6.png') }}" alt="pajak yang disetorkan">
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="single-cat text-center mb-50">
                        ...
                        <div class="cat-cap">
                            ...
                            <ol class="ordered-list text-left">
                                <li>
                                    Pilih jenis wajib pajaknya
                                    <img style="max-width: 100%; margin-top: 1rem; margin-bottom: 1rem;" class="rounded" src="{{ asset('/img/gallery/badan/1.png') }}" alt="pilih jenis pajak">
                                </li>
                                <li>
                                    Apabila wajib pajak berupa badan ataupun perusahaan maka akan muncul tampilan seperti dibawah ini :
                                    <img style="max-width: 100%; margin-top: 1rem; margin-bottom: 1rem;" class="rounded" src="{{ asset('/img/gallery/badan/2.png') }}" alt="kalkulator badan">
                                </li>
                                <li>
                                    Pilih jenis badan usaha
                                    <img style="max-width: 100%; margin-top: 1rem; margin-bottom: 1rem;" class="rounded" src="{{ asset('/img/gallery/badan/3.png') }}" alt="pilih jenis badan usaha">
                                </li>
                                <li>
                                    Masukkan tahun pembuatan NPWP
                                    <img style="max-width: 100%; margin-top: 1rem; margin-bottom: 1rem;" class="rounded" src="{{ asset('/img/gallery/badan/4.png') }}" alt="tahun npwp">
                                </li>
                                <li>
                                    Masukkan peredaran bruto
                                    <img style="max-width: 100%; margin-top: 1rem; margin-bottom: 1rem;" class="rounded" src="{{ asset('/img/gallery/badan/5.png') }}" alt="peredarann bruto">
                                </li>
                                <li>
                                    Masukkan total biaya
                                    <img style="max-width: 100%; margin-top: 1rem; margin-bottom: 1rem;" class="rounded" src="{{ asset('/img/gallery/badan/6.png') }}" alt="total biaya">
                                </li>
                                <li>
                                    Tekan tombol hitung pajak
                                    <img style="max-width: 100%; margin-top: 1rem; margin-bottom: 1rem;" class="rounded" src="{{ asset('/img/gallery/badan/10.png') }}" alt="hitung pajak badan">
                                </li>
                                <li>
                                    Maka akan keluar PKP dan pajak yang harus di setorkan setelah di kalkulasi
                                    <img style="max-width: 100%; margin-top: 1rem; margin-bottom: 1rem;" class="rounded" src="{{ asset('/img/gallery/badan/8.png') }}" alt="pkp">
                                    <img style="max-width: 100%; margin-top: 1rem; margin-bottom: 1rem;" class="rounded" src="{{ asset('/img/gallery/badan/9.png') }}" alt="pajak yg disetorkan">
                                </li>
                            </ol>
                        </div>
                    </div>
...
@section('script')
    <script>
        $(document).ready(function(){
                ...
                if(val_jenis_pajak == 'pribadi'){
                    ...
                    if(field_jenis_badan_usaha.val() == "pt"){
                        ...
                        if( (getCurrentYear() - tahun_pembuatan_npwp) <= 3){
                            ...
                            field_tarif_pajak.attr('placeholder', "Tarif Pajak : 0,5 %");
                            ...
                            // Hitung PKP
                            var pkp = ( parseInt(field_peredaran_bruto.maskMoney('unmasked')[0]*1000) - parseInt(field_total_biaya.maskMoney('unmasked')[0]*1000) );

                            // alert(pkp);
                            // console.log(parseInt(field_peredaran_bruto.maskMoney('unmasked')[0]));
                            // console.log(parseInt(field_total_biaya.maskMoney('unmasked')[0]));
                            ...
                            field_pajak_yang_disetorkan.val(Math.round(pajak)).maskMoney('mask');
                        ...
                        // Jika tahun > 3 tahun
                            ...
                            if(parseInt(field_peredaran_bruto.maskMoney('unmasked')[0]*1000) >= 4800000000){
                                ...
                                // Tampilkan tarif pajak di field_tarif_pajak
                                field_tarif_pajak.attr('placeholder', "Tarif Pajak : 22 %");
                            ...
                            // Jika peredaran bruto < 4,8 milyar (4.800.000.000)
                                ...
                                // alert(parseInt(field_peredaran_bruto.maskMoney('unmasked')[0]));
                                ...
                                // Tampilkan tarif pajak di field_tarif_pajak
                                field_tarif_pajak.attr('placeholder', "Tarif Pajak : 11 %");
            ...
            function validateBadanUsaha(){
                if(field_jenis_badan_usaha.val() == "-"){
                    alert("Jenis Badan Usaha Harus Dipilih Terlebih Dahulu!");
                    return false;
                }
            }
